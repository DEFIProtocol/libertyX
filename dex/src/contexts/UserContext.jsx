...
const API_BASE = process.env.REACT_APP_API_BASE_URL || 'http://libertyx.onrender.com/api';
const USERS_API_URL = `${API_BASE}/users`; // This will be the base for all user routes
